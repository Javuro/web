      ...
      <main className="container mx-auto px-4 py-20">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <Card>
            <CardContent className="p-8">
              <h2 className="text-2xl font-bold mb-4 flex items-center">
                <BookOpen className="mr-2 h-6 w-6 text-emerald-300" />
                1. Definitions
              </h2>
          ...
          <Card>
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-muted-foreground">
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <Check className="h-4 w-4 text-emerald-300 mt-1 mr-2 flex-shrink-0" />
          ...
          <Card>
            <CardContent className="p-8">
              <h2 className="text-2xl font-bold mb-4 flex items-center">
                <Briefcase className="mr-2 h-6 w-6 text-emerald-300" />
          ...
          <Card>
            <CardContent className="p-8">
              <h2 className="text-2xl font-bold mb-4 flex items-center">
                <Settings className="mr-2 h-6 w-6 text-emerald-300" />
          ...
          <Card>
            <CardContent className="p-8">
              <h2 className="text-2xl font-bold mb-4 flex items-center">
                <GanttChart className="mr-2 h-6 w-6 text-emerald-300" />
